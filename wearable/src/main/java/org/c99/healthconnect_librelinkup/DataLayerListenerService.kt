...
import org.c99.healthconnect_librelinkup.complication.BigGlucoseTrendComplicationService
import org.c99.healthconnect_librelinkup.complication.GlucoseComplicationService
import org.c99.healthconnect_librelinkup.complication.GlucoseTrendComplicationService
...
class DataLayerListenerService : WearableListenerService() {
    ...
    override fun onDataChanged(dataEvents: DataEventBuffer) {
        for (event in dataEvents) {
            ...
            ComplicationDataSourceUpdateRequester.create(
                applicationContext,
                ComponentName(applicationContext, GlucoseTrendComplicationService::class.java)
            ).requestUpdateAll()
            ComplicationDataSourceUpdateRequester.create(
                applicationContext,
            ...
            ComplicationDataSourceUpdateRequester.create(
                applicationContext,
                ComponentName(applicationContext, BigGlucoseTrendComplicationService::class.java)
            ).requestUpdateAll()
